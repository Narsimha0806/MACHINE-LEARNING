# -*- coding: utf-8 -*-
"""eval_regression3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1i4oqM_w2nTiqvZau6C2KFaWI6Ed6rG3w
"""
...
Iris_dataset = pd.read_csv("Iris.csv")
input_features = Iris_dataset[['PetalLengthCm', 'PetalWidthCm']] #here petallength and petalwidth are features
target_values = Iris_dataset[['SepalLengthCm']].values #sepallength is target variable
...
plt.title('Training Loss vs Epochs- train_regression3', fontsize=16)
...
model_reg.save_model('regression_model_3.npz')  #saving the trained model to a file .
...
train_features, test_features, train_target, test_target = train_test_split(input_features, target_values, test_size=0.1, random_state=42)

# Load the previously trained regression model
regression_model = BatchLinearRegression()
regression_model.load_model('regression_model_3.npz')

# Evaluate the model on the test set
test_mse = regression_model.score(test_features, test_target)
