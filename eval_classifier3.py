# -*- coding: utf-8 -*-
"""eval_classifier3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_CI9_joFEH3jPf-CutWu7Brdzx27nn8y
"""
...
Iris_dataset = load_iris()
all__length_width_features = Iris_dataset.data  # here we Use sepal length,sepalwidth,petallength,petalwidth as features
target_classes = Iris_dataset.target  # Class labels as target

# here we Split the dataset into training and testing
train_data, test_data, train_labels, test_labels = train_test_split(all_length_width_features, target_classes, test_size=0.1, random_state=42)

loaded_weights = np.load('trained_weights.npy') #saved weights and bias are loaded here .
loaded_bias = np.load('trained_bias.npy')
...
print(f"all_length_width_features Accuracy: {model_accuracy}")