# -*- coding: utf-8 -*-
"""eval_regression4.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/131LFrDTjsW-fIn0fepDaeTqr9C8U8g4t
"""
...
target_values = Iris_dataset[['SepalWidthCm']].values #sepalwidth is target variable
...
plt.title('Training Loss vs Epochs- train_regression4', fontsize=16)
...
model_reg.save_model('regression_model_4.npz')  #saving the trained model to a file .
...
regression_model.load_model('regression_model_4.npz')

# Evaluate the model on the test set
test_mse = regression_model.score(test_features, test_targets)
